    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <p class="ms-2">
            <img src="{{asset('storage/logo/logo_sdm_polri.png')}}" class="h-28 me-3" alt="SDM Logo" />
          </p>
        ...
        <div class="flex items-center gap-4 w-1/6 text-sm">
            @foreach ($user as $item)
              <img class="w-1/4 h-1/4 rounded-full" src="{{asset('storage/photos/'. $item->photo)}}" alt="user photo">
...
<script>
  ...
  navLinks.forEach(link => {
    if(link.href.includes(`${activePage}`)){
      ...
      if(activePage == '/incomingMessage' || activePage == '/outgoingMessage'){
