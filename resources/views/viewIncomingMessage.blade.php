    ...
    <div class="flex flex-col justify-center items-start w-[81%] ml-2">
        <div class="flex flex-col w-full justify-center items-center mx-auto">
            <div class="flex w-full justify-between items-end">
                <h5 class="text-3xl pt-8 pl-24 font-semibold text-gray-900 dark:text-white">Lihat Surat Masuk</h5>
                <a href="{{route('viewSuratMasuk')}}" class="flex items-center mr-24 border justify-center px-4 h-9 text-base font-medium text-white bg-yellow-500 rounded hover:bg-yellow-600 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div class="flex flex-col justify-center items-center pb-4 w-[85%] bg-gray-300 border border-black mt-8 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 overflow-y-auto">
                ...
                <div class="flex pl-6 border-b flex-col w-full pt-0 mb-2 border-black">
                    <h5 class="mb-2 text-xl font-semibold text-gray-900 dark:text-white">Disposisi Kapolda</h5>
                    <p class="mb-2 text-sm font-medium text-gray-900 dark:text-white">{!! nl2br(e($item->disposisi_kapolda)) !!}</p>
                </div> 
                <div class="flex pl-6 border-b flex-col w-full pt-0 mb-2 border-black">
                    <h5 class="mb-2 text-xl font-semibold text-gray-900 dark:text-white">Disposisi Karo SDM</h5>
                    <p class="mb-2 text-sm font-medium text-gray-900 dark:text-white">{!! nl2br(e($item->disposisi_karo_sdm)) !!}</p>
                </div> 
