...
@section('content')
    <h1 class="font-semibold text-2xl ml-6 mt-5 mb-5">Profile</h1>
    <div class="flex flex-col justify-center items-center w-[80%]"> 
      ...
      <div class="flex flex-col justify-center items-center mt-8">
        @foreach ($user as $item)
          <img class="rounded-full w-20" src="{{asset('storage/photos/'. $item->photo)}}" alt="image description">
        @endforeach
          ...
          @foreach ($user as $item)
            <div class="w-[350px]">
              <div class="mt-5">
                ...
                <input name="photo" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file">
                <p class="mt-1 text-sm text-black dark:text-gray-300" id="file_input_help">File input hanya menerima gambar.</p>
              </div>   
              <div class="w-full mt-5">
                <form>
                  <div class="mb-5">
                    <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                    <input type="username" name="username" id="username" value="{{$item->username}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                  </div>
                  <div class="flex justify-center">
                    <button type="submit" class="text-white bg-green-600 hover:bg-green-700 border font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
